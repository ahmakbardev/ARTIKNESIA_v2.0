...
@section('content')
                ...
                <div
                    ...
                    <div class="flex flex-col justify-between bg-white z-[1] group/beli">
                        ...
                        <div class="flex flex-col relative -mt-1">
                            ...
                            <button
                                class="absolute py-1 w-4/6 bottom-2 right-1 translate-y-16 transition-all hidden md:inline ease-in-out group-hover/beli:translate-y-0 text-center btn-color-fill font-normal text-sm rounded-md">Beli
                                <span class="hidden md:inline-flex">Sekarang</span></button>
                            <button
                                class="absolute py-1 w-4/6 bottom-2 right-1 translate-y-16 transition-all inline md:hidden ease-in-out group-hover/belimobile:translate-y-0 text-center btn-color-fill font-normal text-xs md:text-sm rounded-md">Beli
                                <span class="hidden md:inline-flex">Sekarang</span></button>
                        </div>
                    </div>
                </div>
    ...
    <div class="custom-art px-2 md:px-5 lg:px-0 py-20 max-lg:flex max-lg:flex-col lg:grid lg:grid-cols-2 gap-4">
        ...
        <div class="flex flex-col justify-center items-start">
            ...
            <p class="my-4 text-sm md:text-base">Custom Karya Merupakan fitur dimana Kamu bisa membuat karya untuk hadiah
                maupun

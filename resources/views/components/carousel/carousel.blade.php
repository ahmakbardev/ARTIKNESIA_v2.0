<div class="header w-full max-h-32 md:max-h-72 lg:max-h-96 overflow-x-visible mb-5 relative group/btncont group/btn">
    <div class="swiper-container overflow-hidden lg:rounded-md">
        ...
        <!-- Indikator Carousel -->
        <div class=" absolute left-3 flex w-3/4">
        ...
        <div class="opacity-0 group-hover/btncont:opacity-100 hidden md:block transition-all ease-in-out z-10">
            <div
                class="prev absolute left-2 group-hover/btn:left-0 transition-all ease-in-out delay-75 top-1/2 transform -translate-y-1/2 border border-primary bg-white hover:bg-primary hover:text-white text-primary rounded-full w-10 h-10 flex items-center justify-center cursor-pointer z-10">
            ...
            <div
                class="next absolute right-2 group-hover/btn:right-0 transition-all ease-in-out delay-75 top-1/2 transform -translate-y-1/2 border border-primary bg-white hover:bg-primary hover:text-white text-primary rounded-full w-10 h-10 flex items-center justify-center cursor-pointer z-10">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg">

    ...
    <div class="artikel flex flex-col gap-7 lg:flex-row lg:px-0">
        ...
        <div class="mx-auto w-[17.5rem] self-start rounded-lg border border-neutral-400 bg-neutral-50 p-4 lg:mx-0">
            ...
            <div class="relative">
                ...
                <input type="text" id="datepicker-autohide" datepicker datepicker-autohide datepicker-buttons
                    datepicker-format="yyyy/mm/dd" primary="white" datepicker-autoselect-today
